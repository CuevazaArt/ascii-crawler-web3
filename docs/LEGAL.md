...
## 2. License & rights of use

2.1. Source code is released under the **MIT License** (see [LICENSE](../LICENSE)). You may use, copy, modify, merge, publish, distribute, sublicense, and/or sell copies of the Software, subject to retaining the copyright and permission notice.
...
## 3. Terms of Service — acceptable use
...
You must **not** use the Software, related chats, leaderboards, names, memos, or community surfaces to:

- Incite or promote **violence**, self-harm, terrorism, or other **harmful conduct**
- Engage in **hate speech**, harassment, or bullying
- Promote **discrimination** based on race, ethnicity, national origin, religion, sex, gender, sexual orientation, disability, age, or similar protected characteristics
- Promote **racism**, xenophobia, or supremacist ideologies
- Sexually exploit minors or distribute illegal content
